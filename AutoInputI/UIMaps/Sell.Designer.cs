...
namespace AutoInputI.UIMaps.SellClasses
{
    ...
    public partial class Sell
    {
        ...
        /// <summary>
        /// SellMethod - 使用“SellMethodParams”将参数传递到此方法中。
        /// </summary>
        public void SellMethod()
        {
            #region Variable Declarations
            WinMenuItem uI日常交易管理MenuItem = this.UI柜台销售系统Window.UI应用程序MenuBar.UI日常交易管理MenuItem;
            WinMenuItem uI基金赎回MenuItem = this.UI柜台销售系统Window.UI应用程序MenuBar.UI日常交易管理MenuItem.UI基金赎回MenuItem;
            WinEdit uIItemEdit = this.UI基金赎回Window.UIItemWindow.UIItemEdit;
            WinEdit uIItemEdit1 = this.UI密码输入Window.UIItemWindow.UIItemEdit;
            WinEdit uIItemEdit2 = this.UI基金赎回Window.UIItemWindow1.UIItemEdit;
            WinButton uIItemButton = this.UI基金赎回Window.UIItemWindow2.UI基金赎回Client.UIItemButton;
            WinEdit uIItemEdit3 = this.UI基金选择Window.UIItemWindow.UIItemEdit;
            WinButton uI确定YButton = this.UI基金选择Window.UIItemWindow1.UI基金选择Client.UI确定YButton;
            WinComboBox uIItemComboBox = this.UI基金赎回Window.UIItemWindow3.UIItemComboBox;
            WinEdit uIItemEdit4 = this.UI基金赎回Window.UIItemWindow4.UIItemEdit;
            WinComboBox uIItemComboBox1 = this.UI基金赎回Window.UIItemWindow5.UIItemComboBox;
            WinComboBox uIItemComboBox2 = this.UI基金赎回Window.UIItemWindow6.UIItemComboBox;
            WinComboBox uIItemComboBox3 = this.UI基金赎回Window.UIItemWindow7.UIItemComboBox;
            WinButton uI确定OButton = this.UI基金赎回Window.UIItemWindow8.UI基金赎回Client.UI确定OButton;
            ...
            WinButton uI关闭CButton1 = this.UI基金赎回Window.UIItemWindow8.UI基金赎回Client.UI关闭CButton;
            #endregion

            // 单击 “日常交易管理” 菜单项
            Mouse.Click(uI日常交易管理MenuItem, new Point(27, 6));

            // 单击 “日常交易管理” -> “基金赎回” 菜单项
            Mouse.Click(uI基金赎回MenuItem, new Point(48, 4));

            // 在 文本框 中键入“0015”
            uIItemEdit.Text = this.SellMethodParams.UIItemEditText;

            // 在 文本框 中键入“{Enter}”
            Keyboard.SendKeys(uIItemEdit, this.SellMethodParams.UIItemEditSendKeys, ModifierKeys.None);

            // 在 文本框 中键入“********”
            Keyboard.SendKeys(uIItemEdit1, this.SellMethodParams.UIItemEditSendKeys1, true);

            // 在 文本框 中键入“{Enter}”
            Keyboard.SendKeys(uIItemEdit2, this.SellMethodParams.UIItemEditSendKeys2, ModifierKeys.None);

            // 单击 “...” 按钮
            Mouse.Click(uIItemButton, new Point(12, 10));

            // 在 文本框 中键入“000084”
            uIItemEdit3.Text = this.SellMethodParams.UIItemEditText1;

            // 单击 “确定&Y” 按钮
            Mouse.Click(uI确定YButton, new Point(56, 7));

            // 在 组合框 中选择“1|继续赎回”
            uIItemComboBox.SelectedItem = this.SellMethodParams.UIItemComboBoxSelectedItem;

            // 在 文本框 中键入“1000”
            uIItemEdit4.Text = this.SellMethodParams.UIItemEditText2;

            // 在 组合框 中选择“A”
            uIItemComboBox1.SelectedItem = this.SellMethodParams.UIItemComboBoxSelectedItem1;

            // 在 组合框 中选择“1”
            uIItemComboBox2.SelectedItem = this.SellMethodParams.UIItemComboBoxSelectedItem2;

            // 在 组合框 中选择“1”
            uIItemComboBox3.SelectedItem = this.SellMethodParams.UIItemComboBoxSelectedItem3;

            // 单击 “确定&O” 按钮
            Mouse.Click(uI确定OButton, new Point(22, 11));

            // 单击 “是(&Y)” 按钮
            Mouse.Click(uI是YButton, new Point(62, 15));

            // 单击 “关闭&C” 按钮
            Mouse.Click(uI关闭CButton, new Point(25, 10));

            // 单击 “否(&N)” 按钮
            Mouse.Click(uI否NButton, new Point(52, 20));
        ...
        #region Properties
        public virtual SellMethodParams SellMethodParams
        {
            get
            {
                if ((this.mSellMethodParams == null))
                {
                    this.mSellMethodParams = new SellMethodParams();
                }
                return this.mSellMethodParams;
            }
        }
        ...
        public UI基金赎回Window UI基金赎回Window
        {
            get
            {
                if ((this.mUI基金赎回Window == null))
                {
                    this.mUI基金赎回Window = new UI基金赎回Window();
                }
                return this.mUI基金赎回Window;
            }
        }
        ...
        #region Fields
        private SellMethodParams mSellMethodParams;
        
        private UI柜台销售系统Window mUI柜台销售系统Window;
        
        private UI基金赎回Window mUI基金赎回Window;
    ...
    /// <summary>
    /// 要传递到“SellMethod”中的参数
    /// </summary>
    [GeneratedCode("编码的 UI 测试生成器", "14.0.23107.0")]
    public class SellMethodParams
    {
        ...
        /// 在 文本框 中键入“000084”
        /// </summary>
        public string UIItemEditText1 = "000084";
        
        /// <summary>
        /// 在 组合框 中选择“1|继续赎回”
        /// </summary>
        public string UIItemComboBoxSelectedItem = "1|继续赎回";
        ...
        /// 在 组合框 中选择“A”
        /// </summary>
        public string UIItemComboBoxSelectedItem1 = "A";
        ...
        /// 在 组合框 中选择“1”
        /// </summary>
        public string UIItemComboBoxSelectedItem3 = "1";
        #endregion
    }
    ...
    public class UI日常交易管理MenuItem : WinMenuItem
    {
        ...
        #region Properties
        public WinMenuItem UI基金赎回MenuItem
        {
            get
            {
                if ((this.mUI基金赎回MenuItem == null))
                {
                    this.mUI基金赎回MenuItem = new WinMenuItem(this);
                    #region 搜索条件
                    this.mUI基金赎回MenuItem.SearchProperties[WinMenuItem.PropertyNames.Name] = "基金赎回";
                    this.mUI基金赎回MenuItem.SearchConfigurations.Add(SearchConfiguration.ExpandWhileSearching);
                    this.mUI基金赎回MenuItem.WindowTitles.Add("柜台销售系统");
                    #endregion
                }
                return this.mUI基金赎回MenuItem;
            }
        }
        #endregion
        
        #region Fields
        private WinMenuItem mUI基金赎回MenuItem;
        #endregion
    }
    
    [GeneratedCode("编码的 UI 测试生成器", "14.0.23107.0")]
    public class UI基金赎回Window : WinWindow
    {
        
        public UI基金赎回Window()
        {
            #region 搜索条件
            this.SearchProperties[WinWindow.PropertyNames.Name] = "基金赎回";
            this.SearchProperties[WinWindow.PropertyNames.ClassName] = "TFrmRedeem";
            this.WindowTitles.Add("基金赎回");
            #endregion
        }
        ...
        public WinEdit UIItemEdit
        {
            get
            {
                if ((this.mUIItemEdit == null))
                {
                    ...
                    #region 搜索条件
                    this.mUIItemEdit.WindowTitles.Add("基金赎回");
                    #endregion
                }
    ...
    public class UIItemWindow2 : WinWindow
    {
        ...
        #region Properties
        public UI基金赎回Client UI基金赎回Client
        {
            get
            {
                if ((this.mUI基金赎回Client == null))
                {
                    this.mUI基金赎回Client = new UI基金赎回Client(this);
                }
                return this.mUI基金赎回Client;
            }
        }
        #endregion
        
        #region Fields
        private UI基金赎回Client mUI基金赎回Client;
        #endregion
    }
    
    [GeneratedCode("编码的 UI 测试生成器", "14.0.23107.0")]
    public class UI基金赎回Client : WinClient
    {
        
        public UI基金赎回Client(UITestControl searchLimitContainer) : 
                base(searchLimitContainer)
        {
            #region 搜索条件
            this.WindowTitles.Add("基金赎回");
        ...
        public WinButton UIItemButton
        {
            get
            {
                if ((this.mUIItemButton == null))
                {
                    ...
                    this.mUIItemButton.WindowTitles.Add("基金赎回");
                    #endregion
                }
        ...
        public WinComboBox UIItemComboBox
        {
            get
            {
                if ((this.mUIItemComboBox == null))
                {
                    ...
                    #region 搜索条件
                    this.mUIItemComboBox.WindowTitles.Add("基金赎回");
                    #endregion
                }
    ...
    public class UIItemWindow8 : WinWindow
    {
        ...
        #region Properties
        public UI基金赎回Client1 UI基金赎回Client
        {
            get
            {
                if ((this.mUI基金赎回Client == null))
                {
                    this.mUI基金赎回Client = new UI基金赎回Client1(this);
                }
                return this.mUI基金赎回Client;
            }
        }
        ...
        #region Fields
        private UI基金赎回Client1 mUI基金赎回Client;
        #endregion
    }
    
    [GeneratedCode("编码的 UI 测试生成器", "14.0.23107.0")]
    public class UI基金赎回Client1 : WinClient
    {
        
        public UI基金赎回Client1(UITestControl searchLimitContainer) : 
                base(searchLimitContainer)
        {
            #region 搜索条件
            this.WindowTitles.Add("基金赎回");
        ...
        public WinButton UI确定OButton
        {
            get
            {
                if ((this.mUI确定OButton == null))
                {
                    ...
                    this.mUI确定OButton.WindowTitles.Add("基金赎回");
                    #endregion
                }
        ...
        public WinButton UI关闭CButton
        {
            get
            {
                if ((this.mUI关闭CButton == null))
                {
                    ...
                    this.mUI关闭CButton.WindowTitles.Add("基金赎回");
                    #endregion
                }
