...
namespace AutoInputI.UIMaps.RPurchaseClasses
{
    ...
    public partial class RPurchase
    {
        ...
        /// <summary>
        /// RPurchaseMethod - 使用“RPurchaseMethodParams”将参数传递到此方法中。
        /// </summary>
        public void RPurchaseMethod()
        {
            #region Variable Declarations
            WinMenuItem uI基金认购MenuItem = this.UI柜台销售系统Window.UI应用程序MenuBar.UI日常交易管理MenuItem.UI基金认购MenuItem;
            WinEdit uIItemEdit = this.UI基金认购Window.UIItemWindow.UIItemEdit;
            WinButton uIItemButton = this.UI基金认购Window.UIItemWindow1.UI基金认购Client.UIItemButton;
            WinEdit uIItemEdit1 = this.UI密码输入Window.UIItemWindow.UIItemEdit;
            WinEdit uIItemEdit2 = this.UI基金认购Window.UIItemWindow2.UIItemEdit;
            ...
            WinComboBox uIItemComboBox = this.UI基金认购Window.UIItemWindow3.UIItemComboBox;
            WinComboBox uIItemComboBox1 = this.UI基金认购Window.UIItemWindow4.UIItemComboBox;
            WinComboBox uIItemComboBox2 = this.UI基金认购Window.UIItemWindow5.UIItemComboBox;
            WinEdit uIItemEdit4 = this.UI基金认购Window.UIItemWindow6.UIItemEdit;
            WinButton uI确定OButton = this.UI基金认购Window.UIItemWindow7.UI基金认购Client.UI确定OButton;
            ...
            WinButton uI关闭CButton1 = this.UI基金认购Window.UIItemWindow7.UI基金认购Client.UI关闭CButton;
            #endregion

            // 单击 “日常交易管理” -> “基金认购” 菜单项
            Mouse.Click(uI基金认购MenuItem, new Point(44, 4));

            // 在 文本框 中键入“0015”
            uIItemEdit.Text = this.RPurchaseMethodParams.UIItemEditText;

            // 单击 “...” 按钮
            Mouse.Click(uIItemButton, new Point(12, 15));

            // 在 文本框 中键入“********”
            Keyboard.SendKeys(uIItemEdit1, this.RPurchaseMethodParams.UIItemEditSendKeys, true);

            // 在 文本框 中键入“{Enter}”
            Keyboard.SendKeys(uIItemEdit2, this.RPurchaseMethodParams.UIItemEditSendKeys1, ModifierKeys.None);

            // 单击 “...” 按钮
            Mouse.Click(uIItemButton, new Point(6, 12));

            // 在 文本框 中键入“050014”
            uIItemEdit3.Text = this.RPurchaseMethodParams.UIItemEditText1;

            // 单击 “确定&Y” 按钮
            Mouse.Click(uI确定YButton, new Point(23, 20));

            // 在 组合框 中选择“0|金额认购”
            uIItemComboBox.SelectedItem = this.RPurchaseMethodParams.UIItemComboBoxSelectedItem;

            // 在 组合框 中选择“1”
            uIItemComboBox1.SelectedItem = this.RPurchaseMethodParams.UIItemComboBoxSelectedItem1;

            // 在 组合框 中选择“A”
            uIItemComboBox2.SelectedItem = this.RPurchaseMethodParams.UIItemComboBoxSelectedItem2;

            // 在 文本框 中键入“1000”
            uIItemEdit4.Text = this.RPurchaseMethodParams.UIItemEditText2;

            // 单击 “确定&O” 按钮
            Mouse.Click(uI确定OButton, new Point(37, 16));

            // 单击 “是(&Y)” 按钮
            Mouse.Click(uI是YButton, new Point(61, 13));

            // 单击 “关闭&C” 按钮
            Mouse.Click(uI关闭CButton, new Point(20, 9));

            // 单击 “否(&N)” 按钮
            Mouse.Click(uI否NButton, new Point(47, 16));

            // 单击 “关闭&C” 按钮
            Mouse.Click(uI关闭CButton1, new Point(6, 14));
        }
        
        #region Properties
        public virtual RPurchaseMethodParams RPurchaseMethodParams
        {
            get
            {
                if ((this.mRPurchaseMethodParams == null))
                {
                    this.mRPurchaseMethodParams = new RPurchaseMethodParams();
                }
                return this.mRPurchaseMethodParams;
            }
        }
        ...
        public UI基金认购Window UI基金认购Window
        {
            get
            {
                if ((this.mUI基金认购Window == null))
                {
                    this.mUI基金认购Window = new UI基金认购Window();
                }
                return this.mUI基金认购Window;
            }
        }
        ...
        #region Fields
        private RPurchaseMethodParams mRPurchaseMethodParams;
        
        private UI柜台销售系统Window mUI柜台销售系统Window;
        
        private UI基金认购Window mUI基金认购Window;
    ...
    /// <summary>
    /// 要传递到“RPurchaseMethod”中的参数
    /// </summary>
    [GeneratedCode("编码的 UI 测试生成器", "14.0.23107.0")]
    public class RPurchaseMethodParams
    {
        ...
        /// 在 文本框 中键入“050014”
        /// </summary>
        public string UIItemEditText1 = "050014";
        
        /// <summary>
        /// 在 组合框 中选择“0|金额认购”
        /// </summary>
        public string UIItemComboBoxSelectedItem = "0|金额认购";
        ...
        /// 在 组合框 中选择“A”
        /// </summary>
        public string UIItemComboBoxSelectedItem2 = "A";
    ...
    public class UI日常交易管理MenuItem : WinMenuItem
    {
        ...
        #region Properties
        public WinMenuItem UI基金认购MenuItem
        {
            get
            {
                if ((this.mUI基金认购MenuItem == null))
                {
                    this.mUI基金认购MenuItem = new WinMenuItem(this);
                    #region 搜索条件
                    this.mUI基金认购MenuItem.SearchProperties[WinMenuItem.PropertyNames.Name] = "基金认购";
                    this.mUI基金认购MenuItem.SearchConfigurations.Add(SearchConfiguration.ExpandWhileSearching);
                    this.mUI基金认购MenuItem.WindowTitles.Add("柜台销售系统");
                    #endregion
                }
                return this.mUI基金认购MenuItem;
            }
        }
        #endregion
        
        #region Fields
        private WinMenuItem mUI基金认购MenuItem;
        #endregion
    }
    
    [GeneratedCode("编码的 UI 测试生成器", "14.0.23107.0")]
    public class UI基金认购Window : WinWindow
    {
        
        public UI基金认购Window()
        {
            #region 搜索条件
            this.SearchProperties[WinWindow.PropertyNames.Name] = "基金认购";
            this.SearchProperties[WinWindow.PropertyNames.ClassName] = "TFrmSubscribe";
            this.WindowTitles.Add("基金认购");
            #endregion
        }
        ...
        public WinEdit UIItemEdit
        {
            get
            {
                if ((this.mUIItemEdit == null))
                {
                    ...
                    #region 搜索条件
                    this.mUIItemEdit.WindowTitles.Add("基金认购");
                    #endregion
                }
    ...
    public class UIItemWindow1 : WinWindow
    {
        ...
        #region Properties
        public UI基金认购Client UI基金认购Client
        {
            get
            {
                if ((this.mUI基金认购Client == null))
                {
                    this.mUI基金认购Client = new UI基金认购Client(this);
                }
                return this.mUI基金认购Client;
            }
        }
        #endregion
        
        #region Fields
        private UI基金认购Client mUI基金认购Client;
        #endregion
    }
    
    [GeneratedCode("编码的 UI 测试生成器", "14.0.23107.0")]
    public class UI基金认购Client : WinClient
    {
        
        public UI基金认购Client(UITestControl searchLimitContainer) : 
                base(searchLimitContainer)
        {
            #region 搜索条件
            this.WindowTitles.Add("基金认购");
        ...
        public WinButton UIItemButton
        {
            get
            {
                if ((this.mUIItemButton == null))
                {
                    ...
                    this.mUIItemButton.WindowTitles.Add("基金认购");
                    #endregion
                }
        ...
        public WinComboBox UIItemComboBox
        {
            get
            {
                if ((this.mUIItemComboBox == null))
                {
                    ...
                    #region 搜索条件
                    this.mUIItemComboBox.WindowTitles.Add("基金认购");
                    #endregion
                }
    ...
    public class UIItemWindow7 : WinWindow
    {
        ...
        #region Properties
        public UI基金认购Client1 UI基金认购Client
        {
            get
            {
                if ((this.mUI基金认购Client == null))
                {
                    this.mUI基金认购Client = new UI基金认购Client1(this);
                }
                return this.mUI基金认购Client;
            }
        }
        ...
        #region Fields
        private UI基金认购Client1 mUI基金认购Client;
        #endregion
    }
    
    [GeneratedCode("编码的 UI 测试生成器", "14.0.23107.0")]
    public class UI基金认购Client1 : WinClient
    {
        
        public UI基金认购Client1(UITestControl searchLimitContainer) : 
                base(searchLimitContainer)
        {
            #region 搜索条件
            this.WindowTitles.Add("基金认购");
        ...
        public WinButton UI确定OButton
        {
            get
            {
                if ((this.mUI确定OButton == null))
                {
                    ...
                    this.mUI确定OButton.WindowTitles.Add("基金认购");
                    #endregion
                }
        ...
        public WinButton UI关闭CButton
        {
            get
            {
                if ((this.mUI关闭CButton == null))
                {
                    ...
                    this.mUI关闭CButton.WindowTitles.Add("基金认购");
                    #endregion
                }
